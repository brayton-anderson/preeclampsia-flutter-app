import 'package:enclampsia/views/authentication/login/loginscreen.dart';
...
import 'widgets/regstrationscreenview.dart';
    ...
    return SizedBox(
        ...
        child: Column(
            ...
            children: [
              ...
              AppTextWidgets.extraLargeText(null, "Create an account"),
              SizedBox(
                height: 3.h,
              ),
              SizedBox(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.of(ctx).pushNamed(Routes.login,
                      ...
                      child: Center(
                        child: Row(
                          ...
                          children: [
                            ...
                            AppTextWidgets.extraSmallTextTittle(
                                AppColors.kPrimaryColor.shade600, 'Sign in'),
                          ],
                        ),
                      )),
                ),

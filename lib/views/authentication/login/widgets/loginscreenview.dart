...
class LoginScreenView extends StatefulWidget {
  final double? height;
  final double? width;
  const LoginScreenView({Key? key, required this.height, required this.width})
      : super(key: key);
              ...
              children: [
                GestureDetector(
                  onTap: () async {
                    ...
                    if (loginformKey.currentState!.formKey.currentState!.validate()) {
                      ...
                      if (resp == "short") {
                        ...
                        String dt = await aref.watch(authprovider
                            .loginProvider(Ustore(email: email, pass: pass))
                            .future);

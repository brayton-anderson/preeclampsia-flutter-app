import 'subcategories/subcategories_value_forcategories_model.dart';
...
class Categories {
	...
	SubcategoriesValueForCategories? subcategories;

	Categories({this.categorieName, this.categoryIcon, this.categorieActive, this.categorieDetails, this.categorieUid, this.createdAt, this.updatedAt, this.subcategories});
